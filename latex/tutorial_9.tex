...
\begin{frame}[t]
    ...
    \begin{figure}
        \begin{tikzpicture}[scale=1.3, transform shape]
            \draw[step=1cm,color=black] (0, 0) grid (3, 3);
            \node[rectangle,draw,fill = black,minimum width = 1cm,minimum height = 1cm] at (1.5, 1.5) {};
            \node[rectangle,draw,fill = gray,opacity = 0.3,minimum width = 1cm,minimum height = 1cm] at (2.5, 0.5) {};
    
            \node[opacity=0.5] at (0.5, 0.5) {F};
            \node[opacity=0.5] at (1.5, 0.5) {G};
            \node[opacity=0.5] at (2.5, 0.5) {H};
            ...
            \node[font=\tiny] at (2.5, 0.8) {-16};
            \node[font=\tiny] at (2.5, 0.2) {-16};
            \node[font=\tiny] at (2.2, 0.5) {-16};
            \node[font=\tiny] at (2.8, 0.5) {-16};
            
        \end{tikzpicture}
    \end{figure}

    The initial Q-value is $-16$ for all states.
...
\begin{frame}[t]
    ...
    The agent at $F$ moves to the right.
    ...
    \begin{figure}
        \begin{tikzpicture}[scale=1.3, transform shape]
            ...
            \node[font=\tiny] at (1.5, 0.8) {-16};
            \node[font=\tiny] at (1.5, 0.2) {-16};
            \node[font=\tiny] at (1.2, 0.5) {\textcolor{blue}{-16}};
            \node[font=\tiny] at (1.8, 0.5) {-16};
    ...
    Given $\gamma = 0.5$, the reward $r$ for moving to any non-target valid state is $-1$, and the maximum value of $Q(G, a')$ is $-16$,
    \[
        Q(F, \text{right}) = r + \gamma \cdot \max_{a'}Q(s', a') = -1 + 0.5 \times (\textcolor{blue}{-16}) = -9
    \]
    \[
        V(F) = \max_{a}Q(F,a) = -9
    \]
...
\begin{frame}[t]
    ...
    The agent at $G$ moves to the top.
    ...
    Given $\gamma = 0.5$, the reward $r$ for blocked state is $-2$, and the agent cannot move to blocked state, it will stay at $G$, then maximum value of $Q(G, a)$ is $-16$,
    \[
        Q(G, \text{up}) = r + \gamma \cdot \max_{a'}Q(s', a') = -2 + 0.5 \times (\textcolor{blue}{-16}) = -10
    \]
    \[
        V(G) = \max_{a}Q(F,a) = -10
    \]
...
\begin{frame}[t]
    ...
    The agent at $G$ moves to the right.
    ...
    \begin{figure}
        \begin{tikzpicture}[scale=1.3, transform shape]
            ...
            \node[font=\tiny] at (1.5, 0.5) {\textcolor{red}{-8}};
            \node[font=\tiny] at (1.5, 0.8) {-10};
            \node[font=\tiny] at (1.5, 0.2) {-16};
            \node[font=\tiny] at (1.2, 0.5) {-16};
            \node[font=\tiny] at (1.8, 0.5) {\textcolor{red}{-8}};
            ...
            \node[font=\tiny] at (2.5, 0.8) {-16};
            \node[font=\tiny] at (2.5, 0.2) {-16};
            \node[font=\tiny] at (2.2, 0.5) {\textcolor{blue}{-16}};
            \node[font=\tiny] at (2.8, 0.5) {-16};
    ...
    Given $\gamma = 0.5$, the reward $r$ for moving to the target state is $0$, and the maximum value of $Q(H, a)$ is $-16$,
    \[
        Q(G, \text{right}) = r + \gamma \cdot \max_{a'}Q(s', a') = 0 + 0.5 \times (\textcolor{blue}{-16}) = -8
    \]
    \[
        V(G) = \max_{a}Q(G,a) = -8
    \]
...
\textbf{Objective:} Given a set of transactions, find rules that predict the occurrence of an item based on the occurrences of other items in a transaction.
\vspace{1em}

E.g. Given you like ``Doctor Strange'' and ``Captain Marvel'', a recommendation system predicts you will also like ``Avengers:Endgame''.

\vspace*{2em}
\textbf{Association Rule:} An implication expression of the form $X \to Y$, where $X$ and $Y$ are itemsets.
