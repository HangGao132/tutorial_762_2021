...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \item What will be the hypothesis returned by this neural network? \onslide<3->{{\color{red}A matrix of 18 numbers}}
        \item What will be the hypothesis space? \onslide<4->{{\color{red}18-dimensional space of real numbers}}
